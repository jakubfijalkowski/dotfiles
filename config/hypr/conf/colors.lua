-- Catppuccin Mocha
-- This module only defines colors and returns them as a table; it does not
-- call any hl.* functions. Other files pull the colors they need via:
...
M.tint1 = M.teal
M.tint1Alpha = M.tealAlpha

M.tint2 = M.green
M.tint2Alpha = M.greenAlpha

-- $activeBorderColor = rgba($tint1Alphaee) rgba($tint2Alphaee) 45deg
M.activeBorderColor = {
  colors = { "rgba(" .. M.tint1Alpha .. "ee)", "rgba(" .. M.tint2Alpha .. "ee)" },
  angle = 45,
}
-- $inactiveBorderColor = rgba(595959aa)
M.inactiveBorderColor = "rgba(595959aa)"
